...
Sidebar.Properties = function ( editor ) {
	...
	var objectTab = new UI.Text( '模型' ).setPadding('10px 20px').onClick( onClick );
	var geometryTab = new UI.Text( '几何' ).setPadding('10px 20px').onClick( onClick );
	var materialTab = new UI.Text( '材质' ).setPadding('10px 20px').onClick( onClick );

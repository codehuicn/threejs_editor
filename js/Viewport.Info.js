...
Viewport.Info = function ( editor ) {
	...
	container.add( new UI.Text( '模型数量' ), objectsText, new UI.Break() );
	container.add( new UI.Text( '顶点数量' ), verticesText, new UI.Break() );
	container.add( new UI.Text( '三角网格' ), trianglesText, new UI.Break() );
